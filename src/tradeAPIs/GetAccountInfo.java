...
public class GetAccountInfo {
	...
	private static Logger logger = Logger.getLogger(GetAccountInfo.class.getName());
	...
	public GetAccountInfo(String configFile){
...
//				System.out.println(response.toString());
	...
	public String getAccountInfo(String type) throws Exception{
		...
		String params = "tonce="+tonce.toString()+"&accesskey="+ACCESS_KEY+"&requestmethod=post&id=1&method=getAccountInfo&params="+type;
		String hash = getSignature(params, SECRET_KEY);
		...
		if (conn instanceof HttpsURLConnection) {
		  ...
		  //add reuqest header
			...
			String postdata = "{\"method\": \"getAccountInfo\", \"params\": [\""+type+"\"], \"id\": 1}";
