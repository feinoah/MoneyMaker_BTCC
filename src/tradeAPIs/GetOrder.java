...
public class GetOrder {
	...
	private static Logger logger = Logger.getLogger(GetOrder.class.getName());
	...
	public GetOrder(String configFile){
	...
	//	String param_order_id=""+order_id;
		...
		String params = "tonce="+tonce.toString()+"&accesskey="+ACCESS_KEY+"&requestmethod=post&id=1&method=getOrder&params="+param_order_id;
		...
		if (conn instanceof HttpsURLConnection) {
		  ...
		  //add reuqest header
			...
			String postdata = "{\"method\": \"getOrder\", \"params\": ["+param_order_id+"], \"id\": 1}";
...
//			System.out.println(response.toString());
	...
	//	String param_order_id=""+order_id;
		String param_order_id = SubZeroAndDot.removeZero(new Integer(order_id).toString());
		String params = "tonce="+tonce.toString()+"&accesskey="+ACCESS_KEY+"&requestmethod=post&id=1&method=getOrder&params="+param_order_id+","+market;
		String hash = getSignature(params, SECRET_KEY);
		...
		if (conn instanceof HttpsURLConnection) {
		  ...
		  //add reuqest header
			...
			String postdata = "{\"method\": \"getOrder\", \"params\": ["+param_order_id+",\""+market+"\"], \"id\": 1}";
...
//			System.out.println(response.toString());
	...
	//	String param_order_id=""+order_id;
		...
		String params = "tonce="+tonce.toString()+"&accesskey="+ACCESS_KEY+"&requestmethod=post&id=1&method=getOrder&params="+param_order_id+","+market+","+param_withdetail;
		String hash = getSignature(params, SECRET_KEY);
		...
		if (conn instanceof HttpsURLConnection) {
		  ...
		  //add reuqest header
			...
			String postdata = "{\"method\": \"getOrder\", \"params\": ["+param_order_id+",\""+market+"\","+postdata_withdetail+"], \"id\": 1}";
...
//			System.out.println("\nSending 'POST' request to URL : " + apiUrl);
			System.out.println("Post parameters : " + postdata);
			System.out.println("Encrypted parameters : " + params);
//			System.out.println("Response Code : " + responseCode);
