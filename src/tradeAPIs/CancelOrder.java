...
public class CancelOrder {
	...
	private static Logger logger = Logger.getLogger(CancelOrder.class.getName());
	...
	public CancelOrder(String configFile){
	...
	//	String param_order_id=""+order_id;
		...
		String params = "tonce="+tonce.toString()+"&accesskey="+ACCESS_KEY+"&requestmethod=post&id=1&method=cancelOrder&params="+param_order_id;
		...
		if (conn instanceof HttpsURLConnection) {
		  ...
		  //add reuqest header
			...
			String postdata = "{\"method\": \"cancelOrder\", \"params\": ["+param_order_id+"], \"id\": 1}";
...
//			System.out.println(response.toString());
	...
	//	String param_order_id=""+order_id;
		String param_order_id = SubZeroAndDot.removeZero(new Integer(order_id).toString());
		String params = "tonce="+tonce.toString()+"&accesskey="+ACCESS_KEY+"&requestmethod=post&id=1&method=cancelOrder&params="+param_order_id+","+market;
		String hash = getSignature(params, SECRET_KEY);
		...
		if (conn instanceof HttpsURLConnection) {
		  ...
		  //add reuqest header
			...
			String postdata = "{\"method\": \"cancelOrder\", \"params\": ["+param_order_id+",\""+market+"\"], \"id\": 1}";
