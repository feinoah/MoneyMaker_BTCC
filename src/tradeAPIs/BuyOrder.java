...
public class BuyOrder {
	...
	private static Logger logger = Logger.getLogger(BuyOrder.class.getName());
	...
	public BuyOrder(String configFile){
	...
	public String buyOrder2(double price, double amount, String market) throws Exception{
		...
		String params = "tonce="+tonce.toString()+"&accesskey="+ACCESS_KEY+"&requestmethod=post&id=1&method=buyOrder2&params="+param_price+","+param_amount+","+market; //
		...
		if (conn instanceof HttpsURLConnection) {
		  ...
		  //add reuqest header
			...
			String postdata = "{\"method\": \"buyOrder2\", \"params\": ["+postdata_price+","+param_amount+",\""+market+"\"], \"id\": 1}";
