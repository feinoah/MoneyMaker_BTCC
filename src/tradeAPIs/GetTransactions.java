...
public class GetTransactions {
	...
	public GetTransactions(String configFile){
...
//		String param_order_id = SubZeroAndDot.removeZero(new Integer(order_id).toString());
		String params = "tonce="+tonce.toString()+"&accesskey="+ACCESS_KEY+"&requestmethod=post&id=1&method=getTransactions&params=";
		...
		if (conn instanceof HttpsURLConnection) {
		  ...
		  //add reuqest header
			...
			String postdata = "{\"method\": \"getTransactions\", \"params\": [], \"id\": 1}";
...
//			System.out.println(response.toString());
	...
	public String getTransactions(String type, int limit, int offset) throws Exception{
	...
	//	String param_order_id=""+order_id;
		...
		String params = "tonce="+tonce.toString()+"&accesskey="+ACCESS_KEY+"&requestmethod=post&id=1&method=getTransactions&params="+type+","+param_limit+","+param_offset;
		String hash = getSignature(params, SECRET_KEY);
		...
		if (conn instanceof HttpsURLConnection) {
		  ...
		  //add reuqest header
			...
			String postdata = "{\"method\": \"getTransactions\", \"params\": [\""+type+"\","+param_limit+","+param_offset+"], \"id\": 1}";
...
//			System.out.println(response.toString());
	...
	//	String param_order_id=""+order_id;
		...
		String params = "tonce="+tonce.toString()+"&accesskey="+ACCESS_KEY+"&requestmethod=post&id=1&method=getTransactions&params="+type+","+param_limit+","+param_offset+","+param_since+","+sincetype;
		String hash = getSignature(params, SECRET_KEY);
		...
		if (conn instanceof HttpsURLConnection) {
		  ...
		  //add reuqest header
			...
			String postdata = "{\"method\": \"getTransactions\", \"params\": [\""+type+"\","+param_limit+","+param_offset+","+param_since+",\""+sincetype+"\"], \"id\": 1}";
